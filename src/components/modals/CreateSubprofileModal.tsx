...
export type ParamPair = { key: string; value: string };

export type CreateSubprofileModalProps = {
  isOpen: boolean;
  name: string;
  params: ParamPair[];
  requiredKeys: string[];
...
const CreateSubprofileModal: FC<CreateSubprofileModalProps> = ({
  isOpen,
  name,
  params,
  requiredKeys,
  ...
  return (
    <Modal
      ...
      isOpen={isOpen}
      onClose={onClose}
      closeLabel="Close create subprofile"
    >
      <form className="modal__form" onSubmit={onSubmit}>
        <label className="modal__label">
          ...
          <input
            ...
            placeholder="New subprofile name"
...
export default CreateSubprofileModal;
